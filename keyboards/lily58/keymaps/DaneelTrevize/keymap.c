...
[_COLEMAK] = LAYOUT(
  ...
  LALT_T(KC_BSPC), KC_A, KC_R, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_I, KC_O, RALT_T(KC_BSPC),
 ...
 */
[_FN_NAV_KEYS] = LAYOUT(
  KC_TRNS, KC_F11, KC_F12, KC_F13, KC_F14, KC_F15, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_INS,
  KC_SLCK, KC_PGUP, KC_HOME, KC_UP, KC_END, KC_PGDN, KC_NO, KC_EQL, KC_RPRN, KC_LPRN, KC_TRNS, KC_CAPS,
  KC_TRNS, KC_LSFT, KC_LEFT, KC_DOWN, KC_RGHT, KC_PSCR, KC_NO, KC_MINS, KC_RBRC, KC_LBRC, KC_BSLS, KC_TRNS,
