...
[_COLEMAK] = LAYOUT(
  ...
  LSFT_T(KC_BSPC), KC_A, KC_R, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_I, KC_O, RSFT_T(KC_BSPC),
  KC_LGUI, KC_Z, KC_X, KC_C, RALT_T(KC_D), KC_V, KC_DEL, KC_ENT, KC_K, RALT_T(KC_H), KC_COMM, KC_DOT, KC_SLSH, KC_WHOM,
  TO(0), TT(2), TT(1), LCTL_T(KC_SPC), RSFT_T(KC_SPC), TT(1), TT(2), TO(0)
  ),
...
[_FN_NAV_KEYS] = LAYOUT(
  ...
  KC_TAB, KC_PGUP, KC_HOME, KC_UP, KC_END, KC_PGDN, KC_RCBR, KC_EQL, KC_RPRN, KC_LPRN, KC_INS, KC_CAPS,
  KC_TRNS, KC_LALT, KC_LEFT, KC_DOWN, KC_RGHT, KC_PSCR, KC_LCBR, KC_MINS, KC_RBRC, KC_LBRC, KC_BSLS, KC_TRNS,
...
[_NUMS_MIRROR] = LAYOUT(
  ...
  KC_QUOT, KC_SCLN, KC_Y, KC_U, KC_L, KC_J, KC_PPLS, KC_P7, KC_P8, KC_P9, KC_PAST, KC_TRNS,
  KC_TRNS, KC_O, KC_I, KC_E, KC_N, KC_M, KC_PMNS, KC_P4, KC_P5, KC_P6, KC_PSLS, KC_TRNS,
  KC_TRNS, KC_SLSH, KC_DOT, KC_COMM, KC_H, KC_K, KC_ENT, KC_PENT, KC_NLCK, KC_P1, KC_P2, KC_P3, KC_CALC, KC_TRNS,
