...
[_COLEMAK] = LAYOUT(
  ...
  LT(2,KC_BSPC), KC_A, KC_R, KC_S, KC_T, KC_G, KC_M, KC_N, KC_E, KC_I, KC_O, KC_DEL,
  KC_LGUI, KC_Z, KC_X, KC_C, KC_D, KC_V, KC_GRV, KC_SLSH, KC_K, KC_H, KC_DOT, KC_COMM, KC_SCLN, KC_LALT,
...
[_FUNCT] = LAYOUT(
  ...
  KC_F21, KC_F16, KC_F17, KC_F18, KC_F19, KC_F20, KC_SPC, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
...
[_MIRR_NUM] = LAYOUT(
  ...
  KC_WHOM, KC_QUOT, KC_Y, KC_U, KC_L, KC_J, KC_TRNS, KC_P7, KC_P8, KC_P9, KC_TRNS, KC_NLCK,
  KC_DEL, KC_O, KC_I, KC_E, KC_N, KC_M, KC_PPLS, KC_P4, KC_P5, KC_P6, KC_PMNS, KC_CALC,
  KC_LALT, KC_SCLN, KC_COMM, KC_DOT, KC_H, KC_K, KC_SLSH, KC_PDOT, KC_PAST, KC_P1, KC_P2, KC_P3, KC_PSLS, KC_TRNS,
